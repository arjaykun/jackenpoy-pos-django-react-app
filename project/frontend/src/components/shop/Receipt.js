		...
		return (
			<div className={`card p-2 ${ this.props.is_print?'w-50':''}`}>
				<div className="text-center">
					<small><u>Unofficial Receipt</u></small> <br/>
				...
				<table className='w-100'>
					...
					<tbody>
						...
						<tr className="border-top">
							...
							<td className="ml-1">&#8369;{Number(cart.total) + Number(cart.discounted)}</td>
						</tr>
						<tr>
							<td colSpan="3" className="text-right">Discount:</td>
							<td className="ml-1">&#8369;{Number(cart.discounted)}</td>
						</tr>

						<tr>
							<td colSpan="3" className="text-right"><h5><strong>Amount Due:</strong></h5></td>
							<td className="ml-1"><h5>&#8369;{Number(cart.total)}</h5></td>
						</tr>

						<tr className="pt-2 border-top">
							<td colSpan="3" className="text-right">Payment:</td>
							<td className="ml-1"> &#8369;{this.props.payment}</td>
						</tr>
